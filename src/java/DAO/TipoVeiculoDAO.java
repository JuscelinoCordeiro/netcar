...
public class TipoVeiculoDAO {
    ...
    public TipoVeiculoDAO() throws ClassNotFoundException {
...
//    }
    ...
    public List<TipoVeiculo> getListaTipoVeiculos() {
        try {
            ...
            PreparedStatement stmt = this.conexao.prepareStatement("select * from tipo_veiculo");
            ResultSet rs = stmt.executeQuery();

            while (rs.next()) {
                TipoVeiculo tpVeiculo = new TipoVeiculo();

                tpVeiculo.setCdTpVeiculo(rs.getInt("cd_tpveiculo"));
                tpVeiculo.setTipo(rs.getString("tipo"));
